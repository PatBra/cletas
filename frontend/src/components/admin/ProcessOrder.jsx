...
const ProcessOrder = ({ match }) => {
  ...
  useEffect(() => {
    ...
    if (isUpdated) {
      alert.success("El pedido ha sido actualizado con éxito");
  ...
  return (
    <Fragment>
      <MetaData title={`Procesar el Pedido # ${order && order._id}`} />
      <div className="row">
            ...
            {loading ? (
              ...
              <div className="row d-flex justify-content-around">
                <div className="col-12 col-lg-7 order-details">
                  ...
                  <h4 className="mb-4">Detalle de Despacho</h4>
                  <p>
                  ...
                  <h4 className="my-4">Orden de artículos:</h4>
                ...
                <div className="col-12 col-lg-3 mt-5">
                  ...
                  <div className="form-group">
                    ...
                    >
                      <option value="Procesare">Procesar</option>
                      <option value="Trimis">Enviado</option>
                      <option value="Livrat">Entregado</option>
                    </select>
                  </div>
