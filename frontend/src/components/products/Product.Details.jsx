...
const ProductDetails = () => {
    ...
    const { loading, products, error } = useSelector(state => state.productsDetails)
                ...
                <Fragment>
                    ...
                    <div className="row f-flex justify-content-around">
                        ...
                        <div className="col-12 col-lg-5 mt-5">
                            <h3>{products.name}</h3>
                            <p id="product_id">SKU {products._id}</p>
                            ...
                            <p>Stock: <span className={products.stock > 0 ? 'greenColor' : 'redColor'} id="stock_status">{products.stock > 0 ? 'Disponile' : 'No Disponible'}</span></p>
